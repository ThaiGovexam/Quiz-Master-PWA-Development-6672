...
CREATE INDEX IF NOT EXISTS idx_quiz_sets_course_id ON quiz_sets(course_id);
...
INSERT INTO courses (subcategory_id, name, description, price, rating, review_count, student_count)
VALUES
...
INSERT INTO quiz_sets (course_id, name, description, difficulty, question_count, time_limit, pass_score, points)
VALUES
...
INSERT INTO questions (quiz_set_id, question_text, choices, correct_answer, explanation, order_number)
VALUES
